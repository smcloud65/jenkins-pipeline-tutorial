...
pipeline {
    ...
    environment {
	    region = "us-east-1"
        docker_repo_uri = "210068040237.dkr.ecr.us-east-1.amazonaws.com/sample-app"
		task_def_arn = "arn:aws:ecs:us-east-1:210068040237:task-definition/first-run-task-definition:1"
        cluster = "demo0"
